const loadable = require( './Novak_nine_interview_shows_filter');

const callback = function( something, result ) {
    console.log( result );
}

const invoker = loadable.handler;
const eventSample   = getEvent();

invoker( eventSample, null, callback );
